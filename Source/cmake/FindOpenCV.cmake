...
ELSE()
    ...
    FIND_LIBRARY(OpenCV_LIB_STEREO NAMES opencv_stereo HINTS $ENV{OPENCV2DIR} PATH_SUFFIXES lib64 lib lib/x64 lib/x86 PATHS ${OpenCV_SEARCH_PATHS})
    FIND_LIBRARY(OpenCV_LIB_XIMGPROC NAMES opencv_ximgproc HINTS $ENV{OPENCV2DIR} PATH_SUFFIXES lib64 lib lib/x64 lib/x86 PATHS ${OpenCV_SEARCH_PATHS})
    FIND_LIBRARY(OpenCV_LIB_CUDASTEREO NAMES opencv_cudastereo HINTS $ENV{OPENCV2DIR} PATH_SUFFIXES lib64 lib lib/x64 lib/x86 PATHS ${OpenCV_SEARCH_PATHS})
    SET(OpenCV_LIBS ${OpenCV_LIB_CALIB32} ${OpenCV_LIB_FEATURES2D} ${OpenCV_LIB_FLANN} ${OpenCV_LIB_HIGHGUI} ${OpenCV_LIB_VIDEOIO} ${OpenCV_LIB_IMGCODECS} ${OpenCV_LIB_VIDEO} ${OpenCV_LIB_IMGPROC} ${OpenCV_LIB_CORE} ${OpenCV_LIB_STEREO} ${OpenCV_LIB_XIMGPROC} ${OpenCV_LIB_CUDASTEREO})
ENDIF()
